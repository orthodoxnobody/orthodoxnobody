...
date = '2026-01-02'
draft = false
title = "But Where Does Discernment Come From?"
categories = ['Orthodoxy']
[cover]
image = "images/post-header/but-where-does-discernment-come-from.jpg"
alt = "A casually discarded ring of power"
+++
...
>
> Rowan Atkinson’s comedian steps back to see the whole picture. Bombadil steps back far enough to see that the picture is not the world. In both cases, **the act of holding back is not passivity but discernment. It is the ability to say: this matters, but not in the way you think. Or more radically: this does not own me.** 
> ...
> **Power fears nothing more than being treated as a joke.** And Bombadil, quietly, laughingly, teaches us exactly how to do that.
> 
> (all emphasis mine)
